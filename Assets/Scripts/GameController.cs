...
public class GameController : MonoBehaviour
{
    ...
    public void PopulateDatabase()
    {
        m_ItemDatabase.Add("8B0EF21A-F2D9-4E6F-8B79-031CA9E202BA", new ItemDetails()
        {
            ...
            Icon = IconSprites.FirstOrDefault(x => x.name.Equals("UI_Icon_Look")),
            CanDrop = false
        });
        ...
        m_ItemDatabase.Add("992D3386-B743-4CD3-9BB7-0234A057C265", new ItemDetails()
        {
            ...
            Icon = IconSprites.FirstOrDefault(x => x.name.Equals("UI_Icon_Jump")),
            CanDrop = true
        });
        ...
        m_ItemDatabase.Add("1B9C6CAA-754E-412D-91BF-37F22C9A0E7B", new ItemDetails()
        {
            ...
            Icon = IconSprites.FirstOrDefault(x => x.name.Equals("UI_Icon_Move")),
            CanDrop = true
        });
